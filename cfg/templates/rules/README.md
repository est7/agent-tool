...
- `core.md` is an index entrypoint; truly core rules live in `core-*.md`. Non-core domains use descriptive filenames like `conventions.md`, `testing-tdd.md`, `task-memo.md`.
