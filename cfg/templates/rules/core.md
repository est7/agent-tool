...
This file is an index. All original constraints remain unchanged; they are split by domain into the files below.

- `core-reasoning.md`: §1 + §3 (reasoning framework + quality evaluation)
...
- `task-memo.md`: §11 (task memo / 落盘规范)
