---
name: testing-tdd
description: TDD workflow and testing strategy for code implementation. Use when writing tests, implementing features that need tests, or fixing bugs. Defines Red-Green-Refactor gates, integration-first strategy, and test coverage requirements.
---
